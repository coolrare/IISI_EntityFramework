...
namespace IISIConsole.Models
{
    ...
    public partial class ContosoUniversityEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetCourseLite_Result> GetCourseLite(string title)
        {
            var titleParameter = title != null ?
                new ObjectParameter("title", title) :
                new ObjectParameter("title", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCourseLite_Result>("GetCourseLite", titleParameter);
        }
